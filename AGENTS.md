...
config/worker-writing-style.md  optional human-facing prose rules injected verbatim into every worker brief; LOCAL, gitignored, and inherited by secondmate homes; see docs/configuration.md "Worker writing style"
