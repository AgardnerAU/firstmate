...
Nobody reads this chat: the captain and the main firstmate see only what is appended to '/var/folders/41/64hrmnwx11q5lw3l9d7zmfgr0000gn/T/tmp.kEsH0gvfch/present/state/p-sm.status', and a captain-facing sentence that is not appended there has not been sent.
