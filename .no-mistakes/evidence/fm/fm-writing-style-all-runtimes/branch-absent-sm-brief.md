...
Nobody reads this chat: the captain and the main firstmate see only what is appended to '/var/folders/41/64hrmnwx11q5lw3l9d7zmfgr0000gn/T/tmp.kEsH0gvfch/cmp-absent-sm/state/tid.status', and a captain-facing sentence that is not appended there has not been sent.
...
Firstmate steers you through durable message files in '/var/folders/41/64hrmnwx11q5lw3l9d7zmfgr0000gn/T/tmp.kEsH0gvfch/cmp-absent-sm/state/tid.inbox'.
When a terminal message says an instruction is waiting there - and at any natural checkpoint when you are unsure - list '/var/folders/41/64hrmnwx11q5lw3l9d7zmfgr0000gn/T/tmp.kEsH0gvfch/cmp-absent-sm/state/tid.inbox'/*.msg, read and act on each message in numeric order, then acknowledge each handled message by moving it: `mv '/var/folders/41/64hrmnwx11q5lw3l9d7zmfgr0000gn/T/tmp.kEsH0gvfch/cmp-absent-sm/state/tid.inbox'/NNN.msg '/var/folders/41/64hrmnwx11q5lw3l9d7zmfgr0000gn/T/tmp.kEsH0gvfch/cmp-absent-sm/state/tid.inbox'/handled/`.
The move IS the acknowledgement: without it firstmate rings again and eventually treats you as stuck. An empty or absent inbox needs no action.

# Escalation to main firstmate
Handle routine work yourself.
Report only true captain-relevant outcomes or a declared external wait by appending one line:
   `echo "{state} [at=<epoch>]: {one short line}" >> '/var/folders/41/64hrmnwx11q5lw3l9d7zmfgr0000gn/T/tmp.kEsH0gvfch/cmp-absent-sm/state/tid.status' && { [ ! -e '/var/folders/41/64hrmnwx11q5lw3l9d7zmfgr0000gn/T/tmp.kEsH0gvfch/cmp-absent-sm/config/fleet-ledger' ] || '/var/folders/41/64hrmnwx11q5lw3l9d7zmfgr0000gn/T/tmp.kEsH0gvfch/root/bin/fm-fleet-ledger.sh' appended '/var/folders/41/64hrmnwx11q5lw3l9d7zmfgr0000gn/T/tmp.kEsH0gvfch/cmp-absent-sm/config' '/var/folders/41/64hrmnwx11q5lw3l9d7zmfgr0000gn/T/tmp.kEsH0gvfch/cmp-absent-sm/state/tid.status' >/dev/null 2>&1 || true; }`
