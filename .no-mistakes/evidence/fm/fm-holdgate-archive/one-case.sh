...
. /Users/agardner/.no-mistakes/worktrees/c272d8f3fc4c/01M35YGERNPCEJY55C9RGWARYG/tests/lib.sh
...
fail() { echo "not ok - $*"; echo "== err"; cat "$TMP_ROOT/omitted-decision/teardown.err"; echo "== out"; cat "$TMP_ROOT/omitted-decision/teardown.out"; exit 1; }; test_uninventoried_report_decision_refuses_completion
