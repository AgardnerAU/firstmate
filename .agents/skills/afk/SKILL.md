...
A buffered Lavish board answer flushes at once, a buffered item is never added twice, and a board or other process-event item whose result is already handled is dropped before delivery and from the away-return catch-up evidence.
